...
add_filter('dm_auth_providers', function($providers) {
    $providers['google_calendar'] = new DmEvents\Steps\EventImport\Handlers\GoogleCalendar\GoogleCalendarAuth();
    return $providers;
});
...
add_filter('dm_handler_settings', function($all_settings) {
    $all_settings['google_calendar'] = new DmEvents\Steps\EventImport\Handlers\GoogleCalendar\GoogleCalendarSettings();
    return $all_settings;
});