<?php
/**
 * The Burgundy Lounge Event Scraper
 *
 * Scrapes events from The Burgundy Lounge website.
...
if (!class_exists('ChillEvents\Steps\EventImport\Handlers\WebScraper\Scrapers\BurgundyLoungeScraper')) {
...
/**
 * Self-register The Burgundy Lounge scraper with web scraper handler
 */
add_filter('dm_web_scrapers', function($scrapers) {
    $scrapers['the-burgundy-lounge'] = BurgundyLoungeScraper::class;
    return $scrapers;
});
