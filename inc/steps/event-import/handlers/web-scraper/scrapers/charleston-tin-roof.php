<?php
/**
 * Charleston Tin Roof Event Scraper
 *
 * Scrapes events from Charleston Tin Roof iCal feed.
...
if (!class_exists('ChillEvents\Steps\EventImport\Handlers\WebScraper\Scrapers\TinRoofScraper')) {
...
/**
 * Self-register Charleston Tin Roof scraper with web scraper handler
 */
add_filter('dm_web_scrapers', function($scrapers) {
    $scrapers['charleston-tin-roof'] = TinRoofScraper::class;
    return $scrapers;
});
